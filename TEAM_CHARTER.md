...
- สิ่งที่ต้องได้: โค้ดรองรับการพิมพ์คำค้นหา (Input) และสามารถฟิลเตอร์เอาเฉพาะสินค้าที่รหัสตรงกัน หรือชื่อบางส่วนตรงกับคำค้นหามาแสดงผลได้  
...
- สิ่งที่ต้องได้: หน้าจอเมนูหลักที่ผู้ใช้สามารถกดเลือกสลับไปมาระหว่างฟังก์ชันดูสินค้าและฟังก์ชันค้นหาได้ตามใจชอบ โดยที่ระบบไม่ค้างหรือหลุดออกจากโปรแกรมโดยไม่ตั้งใจ และโค้ดผ่านเกณฑ์ Acceptance Criteria ทั้งหมด
